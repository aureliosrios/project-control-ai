          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                <option value="Agentes de IA: Presupuestos, EETT y Cronogramas" className="bg-[#0f172a] text-white">1. Agentes de IA: Presupuestos, EETT y Cronogramas (Inicio: 20 Sep 2026)</option>
