...
### 6B. Cursos Asincrónicos Publicados — Hotmart

| Curso | Link Checkout | Link Temario / Producto | Precio |
|-------|---------------|-------------------------|--------|
...
| Automatización de Cronogramas con IA y MS Project (B2) | `https://pay.hotmart.com/O106954282N` | `https://go.hotmart.com/O106954282N?dp=1` | $14.99 USD |
